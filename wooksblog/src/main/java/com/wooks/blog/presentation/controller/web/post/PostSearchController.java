...
public class PostSearchController {
	...
	public String view(Model model,@RequestParam(defaultValue = "title") String type, @RequestParam(required = true) String query,@PageableDefault(sort = {"id"},direction = Direction.DESC,size = 5) Pageable pageable) {
